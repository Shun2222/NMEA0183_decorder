...
namespace CurrentEstim
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Single LatMax, LatMin, LonMax, LonMin;
            LatMax = (float)36.5;
            LatMin = (float)19.5;
            LonMax = (float)142.5;
            LonMin = (float)119.5;
                ...
                foreach (string inFile in inFiles)
                    using (StreamReader sr = new StreamReader(inFile))
                    {
                        ...
                        do
                        {
                            ...
                            // 指定エリア外なら無効
                            foreach (AIS a in AISList) if (a.LatLonDT.Lat > LatMax || a.LatLonDT.Lat < LatMin || a.LatLonDT.Lon > LonMax || a.LatLonDT.Lon < LonMin) a.Valid = false;
